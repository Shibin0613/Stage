...
namespace PrototypeTransferTool
{
    public partial class Form1 : Form
    {
        ...
        private async void OnCreated(object sender, FileSystemEventArgs e)
        {
            ...
            string fileExtension = System.IO.Path.GetExtension(e.Name);
            string destinationPath = e.FullPath;
            ...
            if (fileExtension == ".PDF" || fileExtension == ".pdf")
            {
                ...
                using (FileStream fileStream = File.Open(e.FullPath, FileMode.Open, FileAccess.Read, FileShare.Read))
            ...
            {
                MessageBox.Show(fileIsAccepted.Replace(".PDF", ".PDF, ").Replace(".pdf", ".PDF, ").Remove(fileIsAccepted.Length - 2, 1) + "is/zijn wel geaccepteerd en omgezet naar XML bestanden");
            }
